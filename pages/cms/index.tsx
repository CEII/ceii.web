        ...
        <section className="flex p-2 mt-16 space-y-5 fle-col m-7 md:gap-12 md:ml-20 md:w-3/4 lg:grid lg:grid-cols-2 lg:gap-8 lg:ml-0 lg:space-y-0 lg:my-auto lg:p-12 lg:w-full lg:place-items-center ">
            ...
            <div className="flex flex-col justify-between pl-4 text-sm text-white rounded-2xl bg-secondary md:h-32 md:pb-2 lg:p-5 lg:h-72 lg:w-9/12 lg:place-self-end hover:bg-white group">
                ...
                <div className="flex justify-end pb-2 pr-4 md:pb-1">
                    <Link href="/cms/users">
                        <a className="flex h-6 pl-5 pr-5 mt-5 text-xs font-medium text-white transition ease-in-out delay-150 rounded-full bg-accent md:text-sm md:px-7 hover:scale-110">Vamos allá</a>
                    </Link>
                </div>
            </div>
            ...
            <div className="flex flex-col justify-between pl-4 text-sm bg-white hover:bg-secondary group rounded-2xl text-secondary md:pb-2 lg:p-5 lg:h-72 lg:w-9/12 lg:place-self-start">
                ...
                <div className="flex justify-end pb-2 pr-4 md:pb-1">
                    <Link href="/cms/users">
                        <a className="h-6 pl-5 pr-5 mt-5 text-xs font-medium text-white transition ease-in-out delay-150 rounded-full bg-accent md:text-sm md:px-7 hover:scale-110">Vamos allá</a>
                    </Link>
                </div>
